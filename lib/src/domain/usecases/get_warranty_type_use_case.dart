...
class GetWarrantyTypeUseCase {
  final FilterRepository _filterRepository;

  GetWarrantyTypeUseCase(this._filterRepository);

  Future<DataState<List<WarrantyType>>> call(FilterRequest request) {
    return _filterRepository.getWarrantyTypes(request);
  }
}
